...
- [x] 09-03-PLAN.md -- _baseline_*.py CUDA p50 measurement + scripts/regenerate_routing_table.py + torch_structured/_routing.json + _should_route_to_cuda + resolver hook + tests/test_perf_grid.py TEST-04 gate + SC#4 reconciliation per D-61a (log_n=4 + _DISABLE_ROUTING) + README Triton-backend section + CHANGELOG.md (Keep a Changelog v1.1)
