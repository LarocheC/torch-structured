...
Gated behind `pytest.importorskip('torch_structured._flashmm')` so this file is
...
pytest.importorskip("torch_structured._flashmm")


def test_flashmm_symbols_available():
    from torch_structured import _flashmm
