...
from torch_structured.factory import make_linear
...
# Test-only hook: flip to True to force _lru_scan into the naive loop,
# e.g. for scan-vs-naive equivalence tests. Do NOT rely on this in
# production code; it is private and may change or be removed.
_FORCE_NAIVE: bool = False
